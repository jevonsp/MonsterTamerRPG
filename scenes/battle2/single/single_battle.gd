...
func connect_signals():
	moves.move_cancelled.connect(_on_move_cancelled)
	options.fight_selected.connect(_on_fight_selected)
...
func _on_fight_selected():
	options.processing = false
	moves.processing = true
	moves.visible = true
